	...
	*/
	...
	function getTableList($skip_authentication = false){
		...
		$arrTables = array(
			...
			'students' => array('Students', '', 'resources/table_icons/group_add.png', 'None'),
			'feescollection' => array('FeesCollection', '', 'resources/table_icons/account_balances.png', 'None'),
			'branch' => array('Branch', '', 'resources/table_icons/card_bank.png', 'None'),
			'teachers' => array('Teachers', '', 'resources/table_icons/blackboard_drawing.png', 'None'),
			'subjects' => array('Subjects', '', 'resources/table_icons/books.png', 'None'),
			'classes' => array('Classes', '', 'resources/table_icons/door_open.png', 'None'),
			'streams' => array('Streams', '', 'resources/table_icons/chart_organisation.png', 'None'),
			'hostels' => array('Hostels', '', 'resources/table_icons/building.png', 'None'),
			'timetable' => array('TimeTable', '', 'resources/table_icons/data_chooser.png', 'None'),
			'events' => array('Events', '', 'resources/table_icons/date_add.png', 'None'),
			'notices' => array(' Notices/Announcements', '', 'resources/table_icons/document_layout.png', 'None'),
			'examresults' => array('Exam Results', '', 'resources/table_icons/application_view_columns.png', 'None'),
			'parents' => array('Parents', '', 'resources/table_icons/reseller_programm.png', 'None'),
			'examcategories' => array('ExamCategories', '', 'resources/table_icons/clipboard_empty.png', 'None'),
			'sessions' => array('Sessions', '', 'resources/table_icons/check_box.png', 'None'),
			'studentcategories' => array('StudentCategories', '', 'resources/table_icons/blackboard_steps.png', 'None'),
			'classattendance' => array('Class Attendance', '', 'resources/table_icons/chart_down_color.png', 'None'),
			'schoolmoney' => array('Fees Structure', '', 'resources/table_icons/coins_add.png', 'None')
		);
	...
	function htmlUserBar(){
		...
		<nav class="navbar navbar-default navbar-fixed-top hidden-print" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?php echo PREPEND_PATH; ?>index.php"><i class="glyphicon glyphicon-home"></i> FANTASTIC SCHOOL ADMIN</a>
			</div>
