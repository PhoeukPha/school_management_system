...
<!--cards and widgets above here-->
            ...
            <div class="container-fluid">
                <nav class="pull-left">
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                <strong>+254708344101</strong>
                            </a>
                        </li>
                    </ul>
                </nav>
                <div class="copyright pull-right">
                    &copy; <script>document.write(new Date().getFullYear())</script>,made with &nbsp;<i class="ti-heart heart"></i> &nbsp;by <a href="http://www.ronaldngoda.rf.gd">Ronald Ronnie</a>
                </div>
            </div>
        </footer>
	...
	<script type="text/javascript">
    	$(document).ready(function(){
        	...
        	$.notify({
            	icon: 'ti-gift',
            	message: "Welcome to <b>Fantastic school admin</b> - a beautiful system for managing your school."
